...
//        glFrontFace(GL_CW);
    ...
    printf("icull:%d,idepth:%d",iCull,iDepth);
...
void SetupRC()
{
    ...
    gltMakeTorus(torusBatch, 1.0f, 0.3f, 20, 5);
...
//    viewFrustum.SetOrthographic(1, 100, 1, 100, 1, 100);

     viewFrustum.SetPerspective(30, float(w)/float(h), 3.0f, 10);
    //4.把透视矩阵加载到透视矩阵对阵中
